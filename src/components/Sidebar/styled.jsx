...
export const LinkLabelStyled = styled.span`
  display: block;
  flex: 1;
  margin-left: ${v.smSpacing};
`;

export const LinkNotificationStyled = styled.div`
  font-size: 14px;
...
export const ThemeStyled = styled.div`
  ...
  font-size: 16px;
`;
export const ThemeLabelStyled = styled.span`
  display: block;
  flex: 1;
`;
...
export const ThemeTogglerStyled = styled.button`
  ...
  position: relative;
`;
export const ToggleThumbStyled = styled.div`
  height: 18px;
  width: 18px;
  position: absolute;
  top: 1px;
